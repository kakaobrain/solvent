...
from solvent.models.primitives import LayerNorm, Linear, triton_linear
from solvent.utils.chunk_utils import chunk_layer
from solvent.utils.tensor_utils import add, permute_final_dims
...
class TriangleMultiplicativeUpdate(nn.Module):
    ...
    def forward(self, 
        ...
        if use_triton and not torch.is_grad_enabled():
            a = a * triton_linear(self.linear_a_g, z, "sigmoid")
            b = b * triton_linear(self.linear_b_g, z, "sigmoid")
        else:
        ...
        if use_triton and not torch.is_grad_enabled():
            g = triton_linear(self.linear_g, z, "sigmoid")
        else:
