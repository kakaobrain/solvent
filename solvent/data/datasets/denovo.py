...
def register_denovo(name, data_dir):
    DatasetCatalog.register(name, lambda: load_denovo(data_dir))
...
dataset_name = 'denovo'
dataset_dir = 'denovo'
register_denovo(dataset_name, os.path.join('datasets', dataset_dir))