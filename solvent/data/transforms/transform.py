...
from solvent.common import residue_constants as rc
...
from . import NUM_EXTRA_SEQ, NUM_MSA_SEQ, NUM_RES, NUM_TEMPLATES
...
@curry1
def make_masked_msa(protein, config):
    ...
    mask_position = torch.rand(sh) < config['replace_fraction']
